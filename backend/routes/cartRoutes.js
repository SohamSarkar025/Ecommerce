    ...
    if (guestCart) {
      ...
      if (userCart) {
        ...
        guestCart.products.forEach((guestItem) => {
          const productsIndex = userCart.products.findIndex(
            (item) =>
          ...
          if (productsIndex > -1) {
            ...
            userCart.products[productsIndex].quantity += guestItem.quantity;
          } else {
            //oherwise , add the guest item to the cart
        ...
        //if the has no existing cart , assign the guest cart to the user
